...
#define Z_STOP_PIN                          PG9     // capteur Tronxy
//#define Z_STOP_PIN                          PA14  // capteur switch optique
...
// Fans
//
#define CONTROLLER_FAN_PIN                  PD6   // MatherBoard FAN
#define FAN_PIN                             PG13  // Bed FAN
#define FAN2_PIN                            PG14  // Extruder FAN
//
// Misc
//
...
#if HAS_SPI_FLASH
  #define SPI_FLASH_SIZE                0x200000  // 2MB octets = 16Mbit
#endif
